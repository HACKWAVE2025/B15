    ...
    <div className="min-h-screen bg-dark-900 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-primary-600 to-primary-800 rounded-full mb-6 shadow-lg shadow-primary-900/50">
            <Shield className="w-8 h-8 text-white" />
            <h1 className="text-3xl font-bold text-white">SentriAI</h1>
          </div>
        ...
        {/* Live Stats Bar */}
        <div className="bg-dark-800 rounded-2xl shadow-2xl shadow-primary-900/20 p-8 mb-12 border border-primary-900/30">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-primary-600 to-primary-800 rounded-full mb-3 shadow-lg shadow-primary-900/50">
            ...
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-primary-500 to-primary-700 rounded-full mb-3 shadow-lg shadow-primary-900/50">
            ...
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-gray-700 to-gray-900 rounded-full mb-3 shadow-lg">
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-dark-800 rounded-2xl shadow-xl p-8 hover:shadow-2xl hover:shadow-primary-900/30 transition-all border border-primary-900/30 hover:border-primary-700">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0">
                  <div className="w-14 h-14 bg-gradient-to-br from-primary-600 to-primary-800 rounded-xl flex items-center justify-center shadow-lg">
        ...
        {/* Key Features */}
        <div className="bg-gradient-to-r from-primary-600 to-primary-800 rounded-2xl shadow-2xl shadow-primary-900/50 p-10 text-white mb-12 border border-primary-700">
        ...
        {/* System Status */}
        <div className="bg-dark-800 rounded-2xl shadow-xl p-8 border border-primary-900/30">
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-dark-800 border border-primary-900/30 rounded-lg text-sm text-gray-300 hover:border-primary-700 transition-colors">
